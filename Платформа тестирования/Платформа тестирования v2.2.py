...
#Возможность использовать вопросы с несколькими вариантами ответа. - вариант: сделать тип вопроса? fix
...
def findTrueAnswer_new(list_of_questions):
...
true_answers_from_selected_questions = findTrueAnswer_new(list_of_questions)
